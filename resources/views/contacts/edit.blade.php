                    ...
                    <form action="{{route('contacts.update', $contact->id)}}" method="POST">
                        ...
                        <div class="container mx-auto flex items-center justify-center">
                            <div class="basis-1 px-4">
                                ...
                                <x-text-input id="name" name="name" class="block mt-1" value="{{$contact['name']}}"  />
                        ...
                        <div class="container mx-auto flex items-center justify-center mt-4">
                            <div class="basis-1 px-4">
                                ...
                                <x-text-input id="contact" name="contact" class="block mt-1" value="{{$contact['contact']}}"   />
                        ...
                        <div class="container mx-auto flex items-center justify-center mt-4">
                            <div class="basis-1 px-4">
                                ...
                                <x-text-input id="email" name="email" class="block mt-1" value="{{$contact['email']}}"   />
